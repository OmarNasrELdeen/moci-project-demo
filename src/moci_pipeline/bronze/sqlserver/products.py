"""Bronze ingestion for sales.products -> <catalog>.bronze.products.
...
def ingest(spark: SparkSession, catalog: str) -> None:
    """Extracts new/changed rows from sales.products since the last
    ...
    query = (
        "SELECT ProductID, ProductCode, ProductName, Category, UnitPrice, "
